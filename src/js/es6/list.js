...
let oLi1 = document.getElementById('center_ul1');
let oLi2 = document.getElementById('center_ul2');
let oLi3 = document.getElementById('center_ul3');
let oDiv1 = document.getElementById('center_div1');
let oDiv2 = document.getElementById('center_div2');
let oDiv3 = document.getElementById('center_div3');
oLi1.onclick = function(){
	oDiv1.style.opacity = sport(oDiv1,{"opacity" : 100});
	oDiv2.style.opacity = sport(oDiv2,{"opacity" : 0});
	oDiv3.style.opacity = sport(oDiv3,{"opacity" : 0});
}
oLi2.onclick = function(){
	oDiv1.style.opacity = sport(oDiv1,{"opacity" : 0});
	oDiv2.style.opacity = sport(oDiv2,{"opacity" : 100});
	oDiv3.style.opacity = sport(oDiv3,{"opacity" : 0});
}
oLi3.onclick = function(){
	oDiv1.style.opacity = sport(oDiv1,{"opacity" : 0});
	oDiv2.style.opacity = sport(oDiv2,{"opacity" : 0});
	oDiv3.style.opacity = sport(oDiv3,{"opacity" : 100});
}

let $li = $('.navigator ul li');
let $div = $('.special');
